...
class CreateSftPackingListsDetailTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sft_packing_lists_detail', function (Blueprint $table) {
            ...
            $table->decimal('shipped_amount', 10, 2)->nullable()->index();
    ...
    {
        Schema::dropIfExists('sft_packing_lists_detail');
    }
}
