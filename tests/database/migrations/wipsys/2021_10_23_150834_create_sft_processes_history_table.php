...
class CreateSftProcessesHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sft_processes_history', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sft_processes_history');
    }
}
