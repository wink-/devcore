...
class CreateSftWorkOrdersHistoryBackupWithPartId0Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sft_work_orders_history_backup_with_part_id_0', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sft_work_orders_history_backup_with_part_id_0');
    }
}
