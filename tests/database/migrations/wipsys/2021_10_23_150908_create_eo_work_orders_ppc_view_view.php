...
class CreateEoWorkOrdersPpcViewView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        return <<<SQL
            DROP VIEW IF EXISTS `eo_work_orders_ppc_view`;
        SQL;
    }
}
