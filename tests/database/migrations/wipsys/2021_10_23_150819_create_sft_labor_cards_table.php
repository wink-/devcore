...
class CreateSftLaborCardsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sft_labor_cards', function (Blueprint $table) {
            $table->integer('work_order_number')->nullable()->index('work_order_number');
            $table->string('employee_code', 10)->nullable();
            $table->string('step_code', 10)->nullable()->index('step_code');
            ...
            $table->string('equipment_code', 10)->nullable()->index('equipment_code');
    ...
    {
        Schema::dropIfExists('sft_labor_cards');
    }
}
