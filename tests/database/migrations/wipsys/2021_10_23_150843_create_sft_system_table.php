...
class CreateSftSystemTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sft_system', function (Blueprint $table) {
            ...
            $table->integer('maximum_unprinted_work_orders');
        });
    }
    ...
    {
        Schema::dropIfExists('sft_system');
    }
}
