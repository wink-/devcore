...
class CreateEoWorkOrdersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('eo_work_orders', function (Blueprint $table) {
            ...
            $table->double('quantity_shipped', 10, 2)->nullable()->default(0.00);
    ...
    {
        Schema::dropIfExists('eo_work_orders');
    }
}
