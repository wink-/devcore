...
class CreateEoDetailWorkOrdersView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        return <<<SQL
            DROP VIEW IF EXISTS `eo_detail_work_orders`;
        SQL;
    }
}
