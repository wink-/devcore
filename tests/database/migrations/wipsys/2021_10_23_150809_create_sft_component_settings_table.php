...
class CreateSftComponentSettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sft_component_settings', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sft_component_settings');
    }
}
