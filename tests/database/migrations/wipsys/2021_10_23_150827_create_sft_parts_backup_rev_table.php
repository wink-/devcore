...
class CreateSftPartsBackupRevTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sft_parts_backup_rev', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sft_parts_backup_rev');
    }
}
