...
class CreateEoWorkOrdersHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('eo_work_orders_history', function (Blueprint $table) {
            $table->integer('number')->nullable()->default(0)->index();
    ...
    {
        Schema::dropIfExists('eo_work_orders_history');
    }
}
