...
class CreateSftWorkOrdersPpcViewView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        return <<<SQL
            DROP VIEW IF EXISTS `sft_work_orders_ppc_view`;
        SQL;
    }
}
