...
class CreateSftInvoicesHistoryViewView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        return <<<SQL
            DROP VIEW IF EXISTS `sft_invoices_history_view`;
        SQL;
    }
}
