...
class CreateSftSessionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sft_sessions', function (Blueprint $table) {
            ...
            $table->string('user_id', 10)->nullable()->default('0')->index('user_id');
    ...
    {
        Schema::dropIfExists('sft_sessions');
    }
}
