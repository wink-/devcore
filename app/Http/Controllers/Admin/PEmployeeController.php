...
use App\Http\Requests\MassDestroyPEmployeeRequest;
...
class PEmployeeController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.pEmployees.index');
    }
    ...
    public function create()
    {
        ...
        return view('admin.pEmployees.create');
    }
    ...
    public function store(StorePEmployeeRequest $request)
    {
        ...
        return redirect()->route('admin.p-employees.index');
    }
    ...
    public function edit(PEmployee $pEmployee)
    {
        ...
        return view('admin.pEmployees.edit', compact('pEmployee'));
    }
    ...
    public function show(PEmployee $pEmployee)
    {
        ...
        return view('admin.pEmployees.show', compact('pEmployee'));
    }
