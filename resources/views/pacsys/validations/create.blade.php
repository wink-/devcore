...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.validation.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("pacsys.validations.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('validation_text') ? 'is-invalid' : '' }}" type="text" name="validation_text" id="validation_text" value="{{ old('validation_text', '') }}">
