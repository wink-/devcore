...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.calcValue.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("pacsys.calc-values.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order_calc') ? 'is-invalid' : '' }}" type="number" name="order_calc" id="order_calc" value="{{ old('order_calc', '1') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('decimal_places') ? 'is-invalid' : '' }}" type="number" name="decimal_places" id="decimal_places" value="{{ old('decimal_places', '') }}" step="1">
