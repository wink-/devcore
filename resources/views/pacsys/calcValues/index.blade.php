...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.calcValue.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-CalcValue">
            <thead>
                <tr>
                    <th width="10">
...
{ data: 'order_calc', name: 'order_calc' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-CalcValue').DataTable(dtOverrideGlobals);
