...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.formValueRange.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("pacsys.form-value-ranges.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_1') ? 'is-invalid' : '' }}" type="text" name="min_1" id="min_1" value="{{ old('min_1', '') }}">
                @if($errors->has('min_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_1') ? 'is-invalid' : '' }}" type="text" name="max_1" id="max_1" value="{{ old('max_1', '') }}">
                @if($errors->has('max_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_2') ? 'is-invalid' : '' }}" type="text" name="min_2" id="min_2" value="{{ old('min_2', '') }}">
                @if($errors->has('min_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_2') ? 'is-invalid' : '' }}" type="text" name="max_2" id="max_2" value="{{ old('max_2', '') }}">
                @if($errors->has('max_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_3') ? 'is-invalid' : '' }}" type="text" name="min_3" id="min_3" value="{{ old('min_3', '') }}">
                @if($errors->has('min_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_3') ? 'is-invalid' : '' }}" type="text" name="max_3" id="max_3" value="{{ old('max_3', '') }}">
                @if($errors->has('max_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_4') ? 'is-invalid' : '' }}" type="text" name="min_4" id="min_4" value="{{ old('min_4', '') }}">
                @if($errors->has('min_4'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_4') ? 'is-invalid' : '' }}" type="text" name="max_4" id="max_4" value="{{ old('max_4', '') }}">
                @if($errors->has('max_4'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_5') ? 'is-invalid' : '' }}" type="text" name="min_5" id="min_5" value="{{ old('min_5', '') }}">
                @if($errors->has('min_5'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_5') ? 'is-invalid' : '' }}" type="text" name="max_5" id="max_5" value="{{ old('max_5', '') }}">
                @if($errors->has('max_5'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_6') ? 'is-invalid' : '' }}" type="text" name="min_6" id="min_6" value="{{ old('min_6', '') }}">
                @if($errors->has('min_6'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_6') ? 'is-invalid' : '' }}" type="text" name="max_6" id="max_6" value="{{ old('max_6', '') }}">
                @if($errors->has('max_6'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_7') ? 'is-invalid' : '' }}" type="text" name="min_7" id="min_7" value="{{ old('min_7', '') }}">
                @if($errors->has('min_7'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_7') ? 'is-invalid' : '' }}" type="text" name="max_7" id="max_7" value="{{ old('max_7', '') }}">
                @if($errors->has('max_7'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_8') ? 'is-invalid' : '' }}" type="text" name="min_8" id="min_8" value="{{ old('min_8', '') }}">
                @if($errors->has('min_8'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_8') ? 'is-invalid' : '' }}" type="text" name="max_8" id="max_8" value="{{ old('max_8', '') }}">
                @if($errors->has('max_8'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_9') ? 'is-invalid' : '' }}" type="text" name="min_9" id="min_9" value="{{ old('min_9', '') }}">
                @if($errors->has('min_9'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_9') ? 'is-invalid' : '' }}" type="text" name="max_9" id="max_9" value="{{ old('max_9', '') }}">
                @if($errors->has('max_9'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_10') ? 'is-invalid' : '' }}" type="text" name="min_10" id="min_10" value="{{ old('min_10', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_10') ? 'is-invalid' : '' }}" type="text" name="max_10" id="max_10" value="{{ old('max_10', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_11') ? 'is-invalid' : '' }}" type="text" name="min_11" id="min_11" value="{{ old('min_11', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_11') ? 'is-invalid' : '' }}" type="text" name="max_11" id="max_11" value="{{ old('max_11', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_12') ? 'is-invalid' : '' }}" type="text" name="min_12" id="min_12" value="{{ old('min_12', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_12') ? 'is-invalid' : '' }}" type="text" name="max_12" id="max_12" value="{{ old('max_12', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_13') ? 'is-invalid' : '' }}" type="text" name="min_13" id="min_13" value="{{ old('min_13', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_13') ? 'is-invalid' : '' }}" type="text" name="max_13" id="max_13" value="{{ old('max_13', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_14') ? 'is-invalid' : '' }}" type="text" name="min_14" id="min_14" value="{{ old('min_14', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_14') ? 'is-invalid' : '' }}" type="text" name="max_14" id="max_14" value="{{ old('max_14', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_15') ? 'is-invalid' : '' }}" type="text" name="min_15" id="min_15" value="{{ old('min_15', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_15') ? 'is-invalid' : '' }}" type="text" name="max_15" id="max_15" value="{{ old('max_15', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_16') ? 'is-invalid' : '' }}" type="text" name="min_16" id="min_16" value="{{ old('min_16', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_16') ? 'is-invalid' : '' }}" type="text" name="max_16" id="max_16" value="{{ old('max_16', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_17') ? 'is-invalid' : '' }}" type="text" name="min_17" id="min_17" value="{{ old('min_17', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_17') ? 'is-invalid' : '' }}" type="text" name="max_17" id="max_17" value="{{ old('max_17', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_18') ? 'is-invalid' : '' }}" type="text" name="min_18" id="min_18" value="{{ old('min_18', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_18') ? 'is-invalid' : '' }}" type="text" name="max_18" id="max_18" value="{{ old('max_18', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_19') ? 'is-invalid' : '' }}" type="text" name="min_19" id="min_19" value="{{ old('min_19', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_19') ? 'is-invalid' : '' }}" type="text" name="max_19" id="max_19" value="{{ old('max_19', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_20') ? 'is-invalid' : '' }}" type="text" name="min_20" id="min_20" value="{{ old('min_20', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_20') ? 'is-invalid' : '' }}" type="text" name="max_20" id="max_20" value="{{ old('max_20', '') }}">
