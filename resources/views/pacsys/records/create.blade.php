...
<div class="card">
    <div class="card-header">
        Create {{ trans('cruds.record.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("pacsys.records.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('form_type') ? 'is-invalid' : '' }}" type="text" name="form_type" id="form_type" value="{{ old('form_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('capacity_old') ? 'is-invalid' : '' }}" type="number" name="capacity_old" id="capacity_old" value="{{ old('capacity_old', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('capacity_unit') ? 'is-invalid' : '' }}" type="text" name="capacity_unit" id="capacity_unit" value="{{ old('capacity_unit', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('capacity') ? 'is-invalid' : '' }}" type="number" name="capacity" id="capacity" value="{{ old('capacity', '') }}" step="0.001">
