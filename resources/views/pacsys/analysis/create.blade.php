...
<div class="card">
    <div class="card-header">
        Create {{ trans('cruds.analysi.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("pacsys.analysis.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_1') ? 'is-invalid' : '' }}" type="text" name="act_value_1" id="act_value_1" value="{{ old('act_value_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_2') ? 'is-invalid' : '' }}" type="text" name="act_value_2" id="act_value_2" value="{{ old('act_value_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_3') ? 'is-invalid' : '' }}" type="text" name="act_value_3" id="act_value_3" value="{{ old('act_value_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_4') ? 'is-invalid' : '' }}" type="text" name="act_value_4" id="act_value_4" value="{{ old('act_value_4', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_5') ? 'is-invalid' : '' }}" type="text" name="act_value_5" id="act_value_5" value="{{ old('act_value_5', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_6') ? 'is-invalid' : '' }}" type="text" name="act_value_6" id="act_value_6" value="{{ old('act_value_6', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_7') ? 'is-invalid' : '' }}" type="text" name="act_value_7" id="act_value_7" value="{{ old('act_value_7', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_8') ? 'is-invalid' : '' }}" type="text" name="act_value_8" id="act_value_8" value="{{ old('act_value_8', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_9') ? 'is-invalid' : '' }}" type="text" name="act_value_9" id="act_value_9" value="{{ old('act_value_9', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_10') ? 'is-invalid' : '' }}" type="text" name="act_value_10" id="act_value_10" value="{{ old('act_value_10', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_11') ? 'is-invalid' : '' }}" type="text" name="act_value_11" id="act_value_11" value="{{ old('act_value_11', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_12') ? 'is-invalid' : '' }}" type="text" name="act_value_12" id="act_value_12" value="{{ old('act_value_12', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_13') ? 'is-invalid' : '' }}" type="text" name="act_value_13" id="act_value_13" value="{{ old('act_value_13', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_14') ? 'is-invalid' : '' }}" type="text" name="act_value_14" id="act_value_14" value="{{ old('act_value_14', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_15') ? 'is-invalid' : '' }}" type="text" name="act_value_15" id="act_value_15" value="{{ old('act_value_15', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_16') ? 'is-invalid' : '' }}" type="text" name="act_value_16" id="act_value_16" value="{{ old('act_value_16', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_17') ? 'is-invalid' : '' }}" type="text" name="act_value_17" id="act_value_17" value="{{ old('act_value_17', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_18') ? 'is-invalid' : '' }}" type="text" name="act_value_18" id="act_value_18" value="{{ old('act_value_18', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_19') ? 'is-invalid' : '' }}" type="text" name="act_value_19" id="act_value_19" value="{{ old('act_value_19', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value_20') ? 'is-invalid' : '' }}" type="text" name="act_value_20" id="act_value_20" value="{{ old('act_value_20', '') }}">
