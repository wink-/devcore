...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.analysisNew.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("pacsys.analysis-news.update", [$analysisNew->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="record_name">{{ trans('cruds.analysisNew.fields.record_name') }}</label>
                <input class="form-control {{ $errors->has('record_name') ? 'is-invalid' : '' }}" type="text" name="record_name" id="record_name" value="{{ old('record_name', $analysisNew->record_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('form_name') ? 'is-invalid' : '' }}" type="text" name="form_name" id="form_name" value="{{ old('form_name', $analysisNew->form_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $analysisNew->date) }}">
                @if($errors->has('date'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_1') ? 'is-invalid' : '' }}" type="text" name="value_1" id="value_1" value="{{ old('value_1', $analysisNew->value_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_2') ? 'is-invalid' : '' }}" type="text" name="value_2" id="value_2" value="{{ old('value_2', $analysisNew->value_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_3') ? 'is-invalid' : '' }}" type="text" name="value_3" id="value_3" value="{{ old('value_3', $analysisNew->value_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_4') ? 'is-invalid' : '' }}" type="text" name="value_4" id="value_4" value="{{ old('value_4', $analysisNew->value_4) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_5') ? 'is-invalid' : '' }}" type="text" name="value_5" id="value_5" value="{{ old('value_5', $analysisNew->value_5) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_6') ? 'is-invalid' : '' }}" type="text" name="value_6" id="value_6" value="{{ old('value_6', $analysisNew->value_6) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_7') ? 'is-invalid' : '' }}" type="text" name="value_7" id="value_7" value="{{ old('value_7', $analysisNew->value_7) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_8') ? 'is-invalid' : '' }}" type="text" name="value_8" id="value_8" value="{{ old('value_8', $analysisNew->value_8) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_9') ? 'is-invalid' : '' }}" type="text" name="value_9" id="value_9" value="{{ old('value_9', $analysisNew->value_9) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_10') ? 'is-invalid' : '' }}" type="text" name="value_10" id="value_10" value="{{ old('value_10', $analysisNew->value_10) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_11') ? 'is-invalid' : '' }}" type="text" name="value_11" id="value_11" value="{{ old('value_11', $analysisNew->value_11) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_12') ? 'is-invalid' : '' }}" type="text" name="value_12" id="value_12" value="{{ old('value_12', $analysisNew->value_12) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_13') ? 'is-invalid' : '' }}" type="text" name="value_13" id="value_13" value="{{ old('value_13', $analysisNew->value_13) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_14') ? 'is-invalid' : '' }}" type="text" name="value_14" id="value_14" value="{{ old('value_14', $analysisNew->value_14) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_15') ? 'is-invalid' : '' }}" type="text" name="value_15" id="value_15" value="{{ old('value_15', $analysisNew->value_15) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_16') ? 'is-invalid' : '' }}" type="text" name="value_16" id="value_16" value="{{ old('value_16', $analysisNew->value_16) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_17') ? 'is-invalid' : '' }}" type="text" name="value_17" id="value_17" value="{{ old('value_17', $analysisNew->value_17) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_18') ? 'is-invalid' : '' }}" type="text" name="value_18" id="value_18" value="{{ old('value_18', $analysisNew->value_18) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_19') ? 'is-invalid' : '' }}" type="text" name="value_19" id="value_19" value="{{ old('value_19', $analysisNew->value_19) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_20') ? 'is-invalid' : '' }}" type="text" name="value_20" id="value_20" value="{{ old('value_20', $analysisNew->value_20) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tank') ? 'is-invalid' : '' }}" type="text" name="tank" id="tank" value="{{ old('tank', $analysisNew->tank) }}">
                @if($errors->has('tank'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emp_code') ? 'is-invalid' : '' }}" type="text" name="emp_code" id="emp_code" value="{{ old('emp_code', $analysisNew->emp_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('time_stamp') ? 'is-invalid' : '' }}" type="text" name="time_stamp" id="time_stamp" value="{{ old('time_stamp', $analysisNew->time_stamp) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('delete_visible') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="delete_visible" id="delete_visible" value="1" {{ $analysisNew->delete_visible || old('delete_visible', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('label') ? 'is-invalid' : '' }}" type="text" name="label" id="label" value="{{ old('label', $analysisNew->label) }}">
                @if($errors->has('label'))
