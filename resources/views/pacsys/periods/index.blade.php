                    ...
                    @foreach($periods as $key => $period)
                        <tr data-entry-id="{{ $period->id }}">
                            ...
                            <td>
                                ...
                                @can('period_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.periods.edit', $period->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('period_delete')
                                    <form action="{{ route('admin.periods.destroy', $period->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('period_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.periods.massDestroy') }}",
