...
<div class="card">
    <div class="card-header">
        Create {{ trans('cruds.action.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("pacsys.actions.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="IDx">{{ trans('cruds.action.fields.IDx') }}</label>
                <input class="form-control {{ $errors->has('IDx') ? 'is-invalid' : '' }}" type="number" name="IDx" id="IDx" value="{{ old('IDx', '0') }}" step="1">
                @if($errors->has('IDx'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('RecordName') ? 'is-invalid' : '' }}" type="text" name="RecordName" id="RecordName" value="{{ old('RecordName', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('FormName') ? 'is-invalid' : '' }}" type="text" name="FormName" id="FormName" value="{{ old('FormName', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ValueName') ? 'is-invalid' : '' }}" type="text" name="ValueName" id="ValueName" value="{{ old('ValueName', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('RecDate') ? 'is-invalid' : '' }}" type="text" name="RecDate" id="RecDate" value="{{ old('RecDate') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('ActDate') ? 'is-invalid' : '' }}" type="text" name="ActDate" id="ActDate" value="{{ old('ActDate') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('RecEmpCode') ? 'is-invalid' : '' }}" type="text" name="RecEmpCode" id="RecEmpCode" value="{{ old('RecEmpCode', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ActValue') ? 'is-invalid' : '' }}" type="text" name="ActValue" id="ActValue" value="{{ old('ActValue', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ScopeName') ? 'is-invalid' : '' }}" type="text" name="ScopeName" id="ScopeName" value="{{ old('ScopeName', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('EmpName') ? 'is-invalid' : '' }}" type="text" name="EmpName" id="EmpName" value="{{ old('EmpName', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('IDy') ? 'is-invalid' : '' }}" type="text" name="IDy" id="IDy" value="{{ old('IDy', '') }}">
                @if($errors->has('IDy'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ValueNum') ? 'is-invalid' : '' }}" type="number" name="ValueNum" id="ValueNum" value="{{ old('ValueNum', '') }}" step="1">
