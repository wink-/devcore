...
@can('form_value_type_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('pacsys.form-value-types.create') }}">
...
@can('form_value_type_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('pacsys.form-value-types.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('pacsys.form-value-types.index') }}",
    columns: [
