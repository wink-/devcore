...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.formValueType.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("pacsys.form-value-types.update", [$formValueType->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="name">{{ trans('cruds.formValueType.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $formValueType->name) }}">
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('form_name') ? 'is-invalid' : '' }}" type="text" name="form_name" id="form_name" value="{{ old('form_name', $formValueType->form_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_1') ? 'is-invalid' : '' }}" type="text" name="type_1" id="type_1" value="{{ old('type_1', $formValueType->type_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_2') ? 'is-invalid' : '' }}" type="text" name="type_2" id="type_2" value="{{ old('type_2', $formValueType->type_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_3') ? 'is-invalid' : '' }}" type="text" name="type_3" id="type_3" value="{{ old('type_3', $formValueType->type_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_4') ? 'is-invalid' : '' }}" type="text" name="type_4" id="type_4" value="{{ old('type_4', $formValueType->type_4) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_5') ? 'is-invalid' : '' }}" type="text" name="type_5" id="type_5" value="{{ old('type_5', $formValueType->type_5) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_6') ? 'is-invalid' : '' }}" type="text" name="type_6" id="type_6" value="{{ old('type_6', $formValueType->type_6) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_7') ? 'is-invalid' : '' }}" type="text" name="type_7" id="type_7" value="{{ old('type_7', $formValueType->type_7) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_8') ? 'is-invalid' : '' }}" type="text" name="type_8" id="type_8" value="{{ old('type_8', $formValueType->type_8) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_9') ? 'is-invalid' : '' }}" type="text" name="type_9" id="type_9" value="{{ old('type_9', $formValueType->type_9) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_10') ? 'is-invalid' : '' }}" type="text" name="type_10" id="type_10" value="{{ old('type_10', $formValueType->type_10) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_11') ? 'is-invalid' : '' }}" type="text" name="type_11" id="type_11" value="{{ old('type_11', $formValueType->type_11) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_12') ? 'is-invalid' : '' }}" type="text" name="type_12" id="type_12" value="{{ old('type_12', $formValueType->type_12) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_13') ? 'is-invalid' : '' }}" type="text" name="type_13" id="type_13" value="{{ old('type_13', $formValueType->type_13) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_14') ? 'is-invalid' : '' }}" type="text" name="type_14" id="type_14" value="{{ old('type_14', $formValueType->type_14) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_15') ? 'is-invalid' : '' }}" type="text" name="type_15" id="type_15" value="{{ old('type_15', $formValueType->type_15) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_16') ? 'is-invalid' : '' }}" type="text" name="type_16" id="type_16" value="{{ old('type_16', $formValueType->type_16) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_17') ? 'is-invalid' : '' }}" type="text" name="type_17" id="type_17" value="{{ old('type_17', $formValueType->type_17) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_18') ? 'is-invalid' : '' }}" type="text" name="type_18" id="type_18" value="{{ old('type_18', $formValueType->type_18) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_19') ? 'is-invalid' : '' }}" type="text" name="type_19" id="type_19" value="{{ old('type_19', $formValueType->type_19) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_20') ? 'is-invalid' : '' }}" type="text" name="type_20" id="type_20" value="{{ old('type_20', $formValueType->type_20) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tank') ? 'is-invalid' : '' }}" type="text" name="tank" id="tank" value="{{ old('tank', $formValueType->tank) }}">
                @if($errors->has('tank'))
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('timestamp') ? 'is-invalid' : '' }}" type="text" name="timestamp" id="timestamp" value="{{ old('timestamp', $formValueType->timestamp) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('false') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="false" id="false" value="1" {{ $formValueType->false || old('false', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('true') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="true" id="true" value="1" {{ $formValueType->true || old('true', 0) === 1 ? 'checked' : '' }}>
