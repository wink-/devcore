...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.formValueAction.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("pacsys.form-value-actions.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_1') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_1" id="action_1" value="1" {{ old('action_1', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_2') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_2" id="action_2" value="1" {{ old('action_2', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_3') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_3" id="action_3" value="1" {{ old('action_3', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_4') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_4" id="action_4" value="1" {{ old('action_4', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_5') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_5" id="action_5" value="1" {{ old('action_5', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_6') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_6" id="action_6" value="1" {{ old('action_6', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_7') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_7" id="action_7" value="1" {{ old('action_7', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_8') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_8" id="action_8" value="1" {{ old('action_8', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_9') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_9" id="action_9" value="1" {{ old('action_9', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_10') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_10" id="action_10" value="1" {{ old('action_10', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_11') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_11" id="action_11" value="1" {{ old('action_11', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_12') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_12" id="action_12" value="1" {{ old('action_12', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_13') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_13" id="action_13" value="1" {{ old('action_13', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_14') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_14" id="action_14" value="1" {{ old('action_14', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_15') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_15" id="action_15" value="1" {{ old('action_15', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_16') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_16" id="action_16" value="1" {{ old('action_16', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_17') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_17" id="action_17" value="1" {{ old('action_17', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_18') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_18" id="action_18" value="1" {{ old('action_18', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_19') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_19" id="action_19" value="1" {{ old('action_19', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('action_20') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="action_20" id="action_20" value="1" {{ old('action_20', 0) == 1 ? 'checked' : '' }}>
