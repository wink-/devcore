...
<div class="card">
    <div class="card-header">
        Edit {{ trans('cruds.formValueAction.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("pacsys.form-value-actions.update", [$formValueAction->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
