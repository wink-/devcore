...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("pacsys.form-value-units.update", [$formValueUnit->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="name">{{ trans('cruds.formValueUnit.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $formValueUnit->name) }}">
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('form_name') ? 'is-invalid' : '' }}" type="text" name="form_name" id="form_name" value="{{ old('form_name', $formValueUnit->form_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_1') ? 'is-invalid' : '' }}" type="text" name="unit_1" id="unit_1" value="{{ old('unit_1', $formValueUnit->unit_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_2') ? 'is-invalid' : '' }}" type="text" name="unit_2" id="unit_2" value="{{ old('unit_2', $formValueUnit->unit_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_3') ? 'is-invalid' : '' }}" type="text" name="unit_3" id="unit_3" value="{{ old('unit_3', $formValueUnit->unit_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_4') ? 'is-invalid' : '' }}" type="text" name="unit_4" id="unit_4" value="{{ old('unit_4', $formValueUnit->unit_4) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_5') ? 'is-invalid' : '' }}" type="text" name="unit_5" id="unit_5" value="{{ old('unit_5', $formValueUnit->unit_5) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_6') ? 'is-invalid' : '' }}" type="text" name="unit_6" id="unit_6" value="{{ old('unit_6', $formValueUnit->unit_6) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_7') ? 'is-invalid' : '' }}" type="text" name="unit_7" id="unit_7" value="{{ old('unit_7', $formValueUnit->unit_7) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_8') ? 'is-invalid' : '' }}" type="text" name="unit_8" id="unit_8" value="{{ old('unit_8', $formValueUnit->unit_8) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_9') ? 'is-invalid' : '' }}" type="text" name="unit_9" id="unit_9" value="{{ old('unit_9', $formValueUnit->unit_9) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_10') ? 'is-invalid' : '' }}" type="text" name="unit_10" id="unit_10" value="{{ old('unit_10', $formValueUnit->unit_10) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_11') ? 'is-invalid' : '' }}" type="text" name="unit_11" id="unit_11" value="{{ old('unit_11', $formValueUnit->unit_11) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_12') ? 'is-invalid' : '' }}" type="text" name="unit_12" id="unit_12" value="{{ old('unit_12', $formValueUnit->unit_12) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_13') ? 'is-invalid' : '' }}" type="text" name="unit_13" id="unit_13" value="{{ old('unit_13', $formValueUnit->unit_13) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_14') ? 'is-invalid' : '' }}" type="text" name="unit_14" id="unit_14" value="{{ old('unit_14', $formValueUnit->unit_14) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_15') ? 'is-invalid' : '' }}" type="text" name="unit_15" id="unit_15" value="{{ old('unit_15', $formValueUnit->unit_15) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_16') ? 'is-invalid' : '' }}" type="text" name="unit_16" id="unit_16" value="{{ old('unit_16', $formValueUnit->unit_16) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_17') ? 'is-invalid' : '' }}" type="text" name="unit_17" id="unit_17" value="{{ old('unit_17', $formValueUnit->unit_17) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_18') ? 'is-invalid' : '' }}" type="text" name="unit_18" id="unit_18" value="{{ old('unit_18', $formValueUnit->unit_18) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_19') ? 'is-invalid' : '' }}" type="text" name="unit_19" id="unit_19" value="{{ old('unit_19', $formValueUnit->unit_19) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_20') ? 'is-invalid' : '' }}" type="text" name="unit_20" id="unit_20" value="{{ old('unit_20', $formValueUnit->unit_20) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tank') ? 'is-invalid' : '' }}" type="text" name="tank" id="tank" value="{{ old('tank', $formValueUnit->tank) }}">
                @if($errors->has('tank'))
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('timestamp') ? 'is-invalid' : '' }}" type="text" name="timestamp" id="timestamp" value="{{ old('timestamp', $formValueUnit->timestamp) }}">
