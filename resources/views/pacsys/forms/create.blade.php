...
<div class="card">
    <div class="card-header">
        Create {{ trans('cruds.form.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("pacsys.forms.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('revision') ? 'is-invalid' : '' }}" type="text" name="revision" id="revision" value="{{ old('revision', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('analysis_procedure') ? 'is-invalid' : '' }}" type="text" name="analysis_procedure" id="analysis_procedure" value="{{ old('analysis_procedure', '') }}">
