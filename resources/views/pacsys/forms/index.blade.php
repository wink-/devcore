...
@can('form_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('pacsys.forms.create') }}">
...
@can('form_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('pacsys.forms.massDestroy') }}",
...
{ data: 'analysis_procedure', name: 'analysis_procedure' },
