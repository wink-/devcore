...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.formValueVisible.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("pacsys.form-value-visibles.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_1') ? 'is-invalid' : '' }}" type="text" name="visible_1" id="visible_1" value="{{ old('visible_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_2') ? 'is-invalid' : '' }}" type="text" name="visible_2" id="visible_2" value="{{ old('visible_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_3') ? 'is-invalid' : '' }}" type="text" name="visible_3" id="visible_3" value="{{ old('visible_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_4') ? 'is-invalid' : '' }}" type="text" name="visible_4" id="visible_4" value="{{ old('visible_4', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_5') ? 'is-invalid' : '' }}" type="text" name="visible_5" id="visible_5" value="{{ old('visible_5', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_6') ? 'is-invalid' : '' }}" type="text" name="visible_6" id="visible_6" value="{{ old('visible_6', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_7') ? 'is-invalid' : '' }}" type="text" name="visible_7" id="visible_7" value="{{ old('visible_7', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_8') ? 'is-invalid' : '' }}" type="text" name="visible_8" id="visible_8" value="{{ old('visible_8', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_9') ? 'is-invalid' : '' }}" type="text" name="visible_9" id="visible_9" value="{{ old('visible_9', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_10') ? 'is-invalid' : '' }}" type="text" name="visible_10" id="visible_10" value="{{ old('visible_10', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_11') ? 'is-invalid' : '' }}" type="text" name="visible_11" id="visible_11" value="{{ old('visible_11', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_12') ? 'is-invalid' : '' }}" type="text" name="visible_12" id="visible_12" value="{{ old('visible_12', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_13') ? 'is-invalid' : '' }}" type="text" name="visible_13" id="visible_13" value="{{ old('visible_13', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_14') ? 'is-invalid' : '' }}" type="text" name="visible_14" id="visible_14" value="{{ old('visible_14', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_15') ? 'is-invalid' : '' }}" type="text" name="visible_15" id="visible_15" value="{{ old('visible_15', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_16') ? 'is-invalid' : '' }}" type="text" name="visible_16" id="visible_16" value="{{ old('visible_16', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_17') ? 'is-invalid' : '' }}" type="text" name="visible_17" id="visible_17" value="{{ old('visible_17', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_18') ? 'is-invalid' : '' }}" type="text" name="visible_18" id="visible_18" value="{{ old('visible_18', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_19') ? 'is-invalid' : '' }}" type="text" name="visible_19" id="visible_19" value="{{ old('visible_19', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visible_20') ? 'is-invalid' : '' }}" type="text" name="visible_20" id="visible_20" value="{{ old('visible_20', '') }}">
