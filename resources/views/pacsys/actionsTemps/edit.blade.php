...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("pacsys.actions-temps.update", [$actionsTemp->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="i_dx">{{ trans('cruds.actionsTemp.fields.i_dx') }}</label>
                <input class="form-control {{ $errors->has('i_dx') ? 'is-invalid' : '' }}" type="number" name="i_dx" id="i_dx" value="{{ old('i_dx', $actionsTemp->i_dx) }}" step="1">
                @if($errors->has('i_dx'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('record_name') ? 'is-invalid' : '' }}" type="text" name="record_name" id="record_name" value="{{ old('record_name', $actionsTemp->record_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('form_name') ? 'is-invalid' : '' }}" type="text" name="form_name" id="form_name" value="{{ old('form_name', $actionsTemp->form_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_name') ? 'is-invalid' : '' }}" type="text" name="value_name" id="value_name" value="{{ old('value_name', $actionsTemp->value_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value') ? 'is-invalid' : '' }}" type="text" name="value" id="value" value="{{ old('value', $actionsTemp->value) }}">
                @if($errors->has('value'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('rec_date') ? 'is-invalid' : '' }}" type="text" name="rec_date" id="rec_date" value="{{ old('rec_date', $actionsTemp->rec_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('act_date') ? 'is-invalid' : '' }}" type="text" name="act_date" id="act_date" value="{{ old('act_date', $actionsTemp->act_date) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('complete') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="complete" id="complete" value="1" {{ $actionsTemp->complete || old('complete', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rec_emp_code') ? 'is-invalid' : '' }}" type="text" name="rec_emp_code" id="rec_emp_code" value="{{ old('rec_emp_code', $actionsTemp->rec_emp_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit') ? 'is-invalid' : '' }}" type="text" name="unit" id="unit" value="{{ old('unit', $actionsTemp->unit) }}">
                @if($errors->has('unit'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('act_value') ? 'is-invalid' : '' }}" type="text" name="act_value" id="act_value" value="{{ old('act_value', $actionsTemp->act_value) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('scope_name') ? 'is-invalid' : '' }}" type="text" name="scope_name" id="scope_name" value="{{ old('scope_name', $actionsTemp->scope_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('comment') ? 'is-invalid' : '' }}" type="text" name="comment" id="comment" value="{{ old('comment', $actionsTemp->comment) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tank') ? 'is-invalid' : '' }}" type="text" name="tank" id="tank" value="{{ old('tank', $actionsTemp->tank) }}">
                @if($errors->has('tank'))
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('time_stamp') ? 'is-invalid' : '' }}" type="text" name="time_stamp" id="time_stamp" value="{{ old('time_stamp', $actionsTemp->time_stamp) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emp_name') ? 'is-invalid' : '' }}" type="text" name="emp_name" id="emp_name" value="{{ old('emp_name', $actionsTemp->emp_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('i_dy') ? 'is-invalid' : '' }}" type="text" name="i_dy" id="i_dy" value="{{ old('i_dy', $actionsTemp->i_dy) }}">
                @if($errors->has('i_dy'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_num') ? 'is-invalid' : '' }}" type="number" name="value_num" id="value_num" value="{{ old('value_num', $actionsTemp->value_num) }}" step="1">
