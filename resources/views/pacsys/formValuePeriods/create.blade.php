...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.formValuePeriod.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("pacsys.form-value-periods.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_1') ? 'is-invalid' : '' }}" type="text" name="period_1" id="period_1" value="{{ old('period_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_2') ? 'is-invalid' : '' }}" type="text" name="period_2" id="period_2" value="{{ old('period_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_3') ? 'is-invalid' : '' }}" type="text" name="period_3" id="period_3" value="{{ old('period_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_4') ? 'is-invalid' : '' }}" type="text" name="period_4" id="period_4" value="{{ old('period_4', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_5') ? 'is-invalid' : '' }}" type="text" name="period_5" id="period_5" value="{{ old('period_5', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_6') ? 'is-invalid' : '' }}" type="text" name="period_6" id="period_6" value="{{ old('period_6', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_7') ? 'is-invalid' : '' }}" type="text" name="period_7" id="period_7" value="{{ old('period_7', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_8') ? 'is-invalid' : '' }}" type="text" name="period_8" id="period_8" value="{{ old('period_8', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_9') ? 'is-invalid' : '' }}" type="text" name="period_9" id="period_9" value="{{ old('period_9', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_10') ? 'is-invalid' : '' }}" type="text" name="period_10" id="period_10" value="{{ old('period_10', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_11') ? 'is-invalid' : '' }}" type="text" name="period_11" id="period_11" value="{{ old('period_11', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_12') ? 'is-invalid' : '' }}" type="text" name="period_12" id="period_12" value="{{ old('period_12', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_13') ? 'is-invalid' : '' }}" type="text" name="period_13" id="period_13" value="{{ old('period_13', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_14') ? 'is-invalid' : '' }}" type="text" name="period_14" id="period_14" value="{{ old('period_14', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_15') ? 'is-invalid' : '' }}" type="text" name="period_15" id="period_15" value="{{ old('period_15', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_16') ? 'is-invalid' : '' }}" type="text" name="period_16" id="period_16" value="{{ old('period_16', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_17') ? 'is-invalid' : '' }}" type="text" name="period_17" id="period_17" value="{{ old('period_17', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_18') ? 'is-invalid' : '' }}" type="text" name="period_18" id="period_18" value="{{ old('period_18', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_19') ? 'is-invalid' : '' }}" type="text" name="period_19" id="period_19" value="{{ old('period_19', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_20') ? 'is-invalid' : '' }}" type="text" name="period_20" id="period_20" value="{{ old('period_20', '') }}">
