...
<div class="card">
    <div class="card-header">
        Create {{ trans('cruds.tag.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("wipsys.tags.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quantity_shipped') ? 'is-invalid' : '' }}" type="number" name="quantity_shipped" id="quantity_shipped" value="{{ old('quantity_shipped', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ordinal') ? 'is-invalid' : '' }}" type="number" name="ordinal" id="ordinal" value="{{ old('ordinal', '1') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('container') ? 'is-invalid' : '' }}" type="text" name="container" id="container" value="{{ old('container', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('printed') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="printed" id="printed" value="1" {{ old('printed', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sessionid') ? 'is-invalid' : '' }}" type="text" name="sessionid" id="sessionid" value="{{ old('sessionid', '') }}">
