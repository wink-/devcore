...
<div class="card">
    <div class="card-header">
        Edit {{ trans('cruds.part.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("wipsys.parts.update", [$part->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                <label for="revision_code">{{ trans('cruds.part.fields.revision_code') }}</label>
                <input class="form-control {{ $errors->has('revision_code') ? 'is-invalid' : '' }}" type="text" name="revision_code" id="revision_code" value="{{ old('revision_code', $part->revision_code) }}">
                @if($errors->has('revision_code'))
                    <span class="text-danger">{{ $errors->first('revision_code') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.part.fields.revision_code_helper') }}</span>
            </div>
            <div class="form-group">
