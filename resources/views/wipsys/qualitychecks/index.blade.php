...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.qualitycheck.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-Qualitycheck">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($qualitychecks as $key => $qualitycheck)
                        <tr data-entry-id="{{ $qualitycheck->id }}">
                            <td>
...
@endcan
  ...
  let table = $('.datatable-Qualitycheck:not(.ajaxTable)').DataTable({ buttons: dtButtons })
