...
<div class="card">
    <div class="card-header">
        Edit {{ trans('cruds.packingListsDetail.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("wipsys.packing-lists-details.update", [$packingListsDetail->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
