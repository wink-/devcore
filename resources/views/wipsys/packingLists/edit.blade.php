...
<div class="card">
    <div class="card-header">
        Edit {{ trans('cruds.packingList.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("wipsys.packing-lists.update", [$packingList->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="number">{{ trans('cruds.packingList.fields.number') }}</label>
                <input class="form-control {{ $errors->has('number') ? 'is-invalid' : '' }}" type="number" name="number" id="number" value="{{ old('number', $packingList->number) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $packingList->date) }}">
                @if($errors->has('date'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('employee_code') ? 'is-invalid' : '' }}" type="text" name="employee_code" id="employee_code" value="{{ old('employee_code', $packingList->employee_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user_code') ? 'is-invalid' : '' }}" type="text" name="user_code" id="user_code" value="{{ old('user_code', $packingList->user_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_code') ? 'is-invalid' : '' }}" type="text" name="customer_code" id="customer_code" value="{{ old('customer_code', $packingList->customer_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('destination_code') ? 'is-invalid' : '' }}" type="text" name="destination_code" id="destination_code" value="{{ old('destination_code', $packingList->destination_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('carrier_code') ? 'is-invalid' : '' }}" type="text" name="carrier_code" id="carrier_code" value="{{ old('carrier_code', $packingList->carrier_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('freight_code') ? 'is-invalid' : '' }}" type="text" name="freight_code" id="freight_code" value="{{ old('freight_code', $packingList->freight_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_purchase_order') ? 'is-invalid' : '' }}" type="text" name="customer_purchase_order" id="customer_purchase_order" value="{{ old('customer_purchase_order', $packingList->customer_purchase_order) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('cod') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="cod" id="cod" value="1" {{ $packingList->cod || old('cod', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_received') ? 'is-invalid' : '' }}" type="text" name="date_received" id="date_received" value="{{ old('date_received', $packingList->date_received) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('printed') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="printed" id="printed" value="1" {{ $packingList->printed || old('printed', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="printed">{{ trans('cruds.packingList.fields.printed') }}</label>
                </div>
                @if($errors->has('printed'))
                    <span class="text-danger">{{ $errors->first('printed') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.packingList.fields.printed_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="session">{{ trans('cruds.packingList.fields.session') }}</label>
                <input class="form-control {{ $errors->has('session') ? 'is-invalid' : '' }}" type="text" name="session" id="session" value="{{ old('session', $packingList->session) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('archive') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="archive" id="archive" value="1" {{ $packingList->archive || old('archive', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('revision') ? 'is-invalid' : '' }}" type="number" name="revision" id="revision" value="{{ old('revision', $packingList->revision) }}" step="1">
