...
<div class="card">
    <div class="card-header">
        Create {{ trans('cruds.invoice.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("wipsys.invoices.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emails') ? 'is-invalid' : '' }}" type="text" name="emails" id="emails" value="{{ old('emails', '') }}">
