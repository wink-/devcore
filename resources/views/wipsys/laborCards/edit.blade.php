...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.laborCard.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.labor-cards.update", [$laborCard->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="work_order_number">{{ trans('cruds.laborCard.fields.work_order_number') }}</label>
                <input class="form-control {{ $errors->has('work_order_number') ? 'is-invalid' : '' }}" type="number" name="work_order_number" id="work_order_number" value="{{ old('work_order_number', $laborCard->work_order_number) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('employee_code') ? 'is-invalid' : '' }}" type="text" name="employee_code" id="employee_code" value="{{ old('employee_code', $laborCard->employee_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('step_code') ? 'is-invalid' : '' }}" type="text" name="step_code" id="step_code" value="{{ old('step_code', $laborCard->step_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('job_date') ? 'is-invalid' : '' }}" type="text" name="job_date" id="job_date" value="{{ old('job_date', $laborCard->job_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('time_of_day') ? 'is-invalid' : '' }}" type="text" name="time_of_day" id="time_of_day" value="{{ old('time_of_day', $laborCard->time_of_day) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('actual_hours') ? 'is-invalid' : '' }}" type="number" name="actual_hours" id="actual_hours" value="{{ old('actual_hours', $laborCard->actual_hours) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('man_hours') ? 'is-invalid' : '' }}" type="number" name="man_hours" id="man_hours" value="{{ old('man_hours', $laborCard->man_hours) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('actual_pieces') ? 'is-invalid' : '' }}" type="number" name="actual_pieces" id="actual_pieces" value="{{ old('actual_pieces', $laborCard->actual_pieces) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('equipment_code') ? 'is-invalid' : '' }}" type="text" name="equipment_code" id="equipment_code" value="{{ old('equipment_code', $laborCard->equipment_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('equipment_quantity') ? 'is-invalid' : '' }}" type="number" name="equipment_quantity" id="equipment_quantity" value="{{ old('equipment_quantity', $laborCard->equipment_quantity) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('loads') ? 'is-invalid' : '' }}" type="number" name="loads" id="loads" value="{{ old('loads', $laborCard->loads) }}" step="0.01">
                @if($errors->has('loads'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cycle_time') ? 'is-invalid' : '' }}" type="number" name="cycle_time" id="cycle_time" value="{{ old('cycle_time', $laborCard->cycle_time) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('time_finished') ? 'is-invalid' : '' }}" type="text" name="time_finished" id="time_finished" value="{{ old('time_finished', $laborCard->time_finished) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('session') ? 'is-invalid' : '' }}" type="text" name="session" id="session" value="{{ old('session', $laborCard->session) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('archive') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="archive" id="archive" value="1" {{ $laborCard->archive || old('archive', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('revision') ? 'is-invalid' : '' }}" type="number" name="revision" id="revision" value="{{ old('revision', $laborCard->revision) }}" step="1">
