...
<div class="card">
    <div class="card-header">
        Create {{ trans('cruds.quote.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("wipsys.quotes.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_rfq') ? 'is-invalid' : '' }}" type="text" name="customer_rfq" id="customer_rfq" value="{{ old('customer_rfq', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('revision_code') ? 'is-invalid' : '' }}" type="text" name="revision_code" id="revision_code" value="{{ old('revision_code', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('process') ? 'is-invalid' : '' }}" name="process_id" id="process_id" required>
                    @foreach($processes as $id => $entry)
                        <option value="{{ $id }}" {{ old('process_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
