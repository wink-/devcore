...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.amp.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover compact ajaxTable datatable datatable-Amp">
            <thead>
                <tr>
                    <th width="10">
                ...
                <tr>
                    ...
                    <td>
                        <select class="search">
                            ...
                            @foreach($pd_records as $key => $item)
...
{ data: 'id', name: 'id' },
{ data: 'record_name', name: 'record.name' },
{ data: 'record.description', name: 'record.description' },
{ data: 'amp', name: 'amp' },
{ data: 'amp_minute', name: 'amp_minute' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Amp').DataTable(dtOverrideGlobals);
