...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.packingListsDetail.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.packing-lists-details.update", [$packingListsDetail->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="packing_list_number">{{ trans('cruds.packingListsDetail.fields.packing_list_number') }}</label>
                <input class="form-control {{ $errors->has('packing_list_number') ? 'is-invalid' : '' }}" type="number" name="packing_list_number" id="packing_list_number" value="{{ old('packing_list_number', $packingListsDetail->packing_list_number) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tag_number') ? 'is-invalid' : '' }}" type="number" name="tag_number" id="tag_number" value="{{ old('tag_number', $packingListsDetail->tag_number) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('work_order_number') ? 'is-invalid' : '' }}" type="number" name="work_order_number" id="work_order_number" value="{{ old('work_order_number', $packingListsDetail->work_order_number) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('part') ? 'is-invalid' : '' }}" type="number" name="part" id="part" value="{{ old('part', $packingListsDetail->part) }}" step="1">
                @if($errors->has('part'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('part_number') ? 'is-invalid' : '' }}" type="text" name="part_number" id="part_number" value="{{ old('part_number', $packingListsDetail->part_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_code') ? 'is-invalid' : '' }}" type="text" name="customer_code" id="customer_code" value="{{ old('customer_code', $packingListsDetail->customer_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('destination_code') ? 'is-invalid' : '' }}" type="text" name="destination_code" id="destination_code" value="{{ old('destination_code', $packingListsDetail->destination_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('process_code') ? 'is-invalid' : '' }}" type="text" name="process_code" id="process_code" value="{{ old('process_code', $packingListsDetail->process_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('method_code') ? 'is-invalid' : '' }}" type="text" name="method_code" id="method_code" value="{{ old('method_code', $packingListsDetail->method_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_packing_list') ? 'is-invalid' : '' }}" type="text" name="customer_packing_list" id="customer_packing_list" value="{{ old('customer_packing_list', $packingListsDetail->customer_packing_list) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_purchase_order') ? 'is-invalid' : '' }}" type="text" name="customer_purchase_order" id="customer_purchase_order" value="{{ old('customer_purchase_order', $packingListsDetail->customer_purchase_order) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('certification_number') ? 'is-invalid' : '' }}" type="number" name="certification_number" id="certification_number" value="{{ old('certification_number', $packingListsDetail->certification_number) }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('certify') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="certify" id="certify" value="1" {{ $packingListsDetail->certify || old('certify', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tag_quantity') ? 'is-invalid' : '' }}" type="number" name="tag_quantity" id="tag_quantity" value="{{ old('tag_quantity', $packingListsDetail->tag_quantity) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tag_quantity_shipped') ? 'is-invalid' : '' }}" type="number" name="tag_quantity_shipped" id="tag_quantity_shipped" value="{{ old('tag_quantity_shipped', $packingListsDetail->tag_quantity_shipped) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quantity') ? 'is-invalid' : '' }}" type="number" name="quantity" id="quantity" value="{{ old('quantity', $packingListsDetail->quantity) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shipped_amount') ? 'is-invalid' : '' }}" type="number" name="shipped_amount" id="shipped_amount" value="{{ old('shipped_amount', $packingListsDetail->shipped_amount) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('packing_list_date') ? 'is-invalid' : '' }}" type="text" name="packing_list_date" id="packing_list_date" value="{{ old('packing_list_date', $packingListsDetail->packing_list_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_received') ? 'is-invalid' : '' }}" type="text" name="date_received" id="date_received" value="{{ old('date_received', $packingListsDetail->date_received) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('session') ? 'is-invalid' : '' }}" type="text" name="session" id="session" value="{{ old('session', $packingListsDetail->session) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('archive') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="archive" id="archive" value="1" {{ $packingListsDetail->archive || old('archive', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('revision') ? 'is-invalid' : '' }}" type="number" name="revision" id="revision" value="{{ old('revision', $packingListsDetail->revision) }}" step="1">
