...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.formValueVisible.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.form-value-visibles.update", [$formValueVisible->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
