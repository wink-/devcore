...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.up.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.ups.update", [$up->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="tracking_number">{{ trans('cruds.up.fields.tracking_number') }}</label>
                <input class="form-control {{ $errors->has('tracking_number') ? 'is-invalid' : '' }}" type="text" name="tracking_number" id="tracking_number" value="{{ old('tracking_number', $up->tracking_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('receiver_name') ? 'is-invalid' : '' }}" type="text" name="receiver_name" id="receiver_name" value="{{ old('receiver_name', $up->receiver_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shipment_process_timestamp') ? 'is-invalid' : '' }}" type="text" name="shipment_process_timestamp" id="shipment_process_timestamp" value="{{ old('shipment_process_timestamp', $up->shipment_process_timestamp) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('service_type') ? 'is-invalid' : '' }}" type="text" name="service_type" id="service_type" value="{{ old('service_type', $up->service_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weight') ? 'is-invalid' : '' }}" type="number" name="weight" id="weight" value="{{ old('weight', $up->weight) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ref_1') ? 'is-invalid' : '' }}" type="text" name="ref_1" id="ref_1" value="{{ old('ref_1', $up->ref_1) }}">
                @if($errors->has('ref_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ref_2') ? 'is-invalid' : '' }}" type="text" name="ref_2" id="ref_2" value="{{ old('ref_2', $up->ref_2) }}">
                @if($errors->has('ref_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ref_3') ? 'is-invalid' : '' }}" type="text" name="ref_3" id="ref_3" value="{{ old('ref_3', $up->ref_3) }}">
                @if($errors->has('ref_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ref_4') ? 'is-invalid' : '' }}" type="text" name="ref_4" id="ref_4" value="{{ old('ref_4', $up->ref_4) }}">
                @if($errors->has('ref_4'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ref_5') ? 'is-invalid' : '' }}" type="text" name="ref_5" id="ref_5" value="{{ old('ref_5', $up->ref_5) }}">
                @if($errors->has('ref_5'))
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('archive') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="archive" id="archive" value="1" {{ $up->archive || old('archive', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('revision') ? 'is-invalid' : '' }}" type="number" name="revision" id="revision" value="{{ old('revision', $up->revision) }}" step="1">
