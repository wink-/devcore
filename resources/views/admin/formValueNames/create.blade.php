...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.formValueName.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.form-value-names.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_6') ? 'is-invalid' : '' }}" type="text" name="name_6" id="name_6" value="{{ old('name_6', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_7') ? 'is-invalid' : '' }}" type="text" name="name_7" id="name_7" value="{{ old('name_7', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_8') ? 'is-invalid' : '' }}" type="text" name="name_8" id="name_8" value="{{ old('name_8', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_9') ? 'is-invalid' : '' }}" type="text" name="name_9" id="name_9" value="{{ old('name_9', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_10') ? 'is-invalid' : '' }}" type="text" name="name_10" id="name_10" value="{{ old('name_10', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_11') ? 'is-invalid' : '' }}" type="text" name="name_11" id="name_11" value="{{ old('name_11', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_12') ? 'is-invalid' : '' }}" type="text" name="name_12" id="name_12" value="{{ old('name_12', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_13') ? 'is-invalid' : '' }}" type="text" name="name_13" id="name_13" value="{{ old('name_13', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_14') ? 'is-invalid' : '' }}" type="text" name="name_14" id="name_14" value="{{ old('name_14', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_15') ? 'is-invalid' : '' }}" type="text" name="name_15" id="name_15" value="{{ old('name_15', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_16') ? 'is-invalid' : '' }}" type="text" name="name_16" id="name_16" value="{{ old('name_16', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_17') ? 'is-invalid' : '' }}" type="text" name="name_17" id="name_17" value="{{ old('name_17', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_18') ? 'is-invalid' : '' }}" type="text" name="name_18" id="name_18" value="{{ old('name_18', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_19') ? 'is-invalid' : '' }}" type="text" name="name_19" id="name_19" value="{{ old('name_19', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_20') ? 'is-invalid' : '' }}" type="text" name="name_20" id="name_20" value="{{ old('name_20', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('blank') ? 'is-invalid' : '' }}" type="text" name="blank" id="blank" value="{{ old('blank', '') }}">
                @if($errors->has('blank'))
